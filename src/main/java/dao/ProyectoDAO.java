...
//    public static final String GET_IMAGE = "SELECT projects FROM ";
    ...
    public static final String UPDATE_IMAGE = "UPDATE projects SET image_project = ? WHERE name_project = ?";
...
//            proyecto.setUrlImagen(rst.getString(4));
    ...
    public int actualizarProyecto(ProyectoDTO proyecto) throws Exception{
        ...
        ps.setInt(4, proyecto.getId_proyecto());
    ...
    public int actualizarImagen(ProyectoDTO proyecto) throws Exception{
        
        ConnectionDB conexion = new ConnectionDB();
        Connection con = conexion.getConnection("ProyectoDAO.actualizarImagen");       
        PreparedStatement ps = null;
        
        int registros = 0;
        
        ps = con.prepareStatement(this.UPDATE_IMAGE);
        
        ps.setString(2, proyecto.getTitulo());
        ps.setString(1, proyecto.getImagen());
...
//        ps.setString(4, proyecto.getImagen());
